      ...
      <div className="flex flex-1 flex-col p-2 sm:p-4">
        ...
        <dl className="mt-2 hidden text-xs text-ink-light sm:block">
          <div className="flex min-w-0 items-center gap-2">
            <dt className="shrink-0 whitespace-nowrap text-ink-muted">{t("difficulty")}</dt>
            <dd className="min-w-0 font-medium text-ink">{localizeDifficulty(play.difficulty, useLocale())}</dd>
          </div>
          <div className="flex min-w-0 items-center gap-2">
            <dt className="shrink-0 whitespace-nowrap text-ink-muted">{t("techStack")}</dt>
            <dd className="min-w-0 truncate font-medium text-ink">{play.techStack.join(" / ")}</dd>
          </div>
          <div className="flex min-w-0 items-center gap-2">
            <dt className="shrink-0 whitespace-nowrap text-ink-muted">{t("corePoints")}</dt>
